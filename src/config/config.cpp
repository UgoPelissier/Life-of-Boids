...
const size_t DEFAULT_NUM_AGENTS = 100;
const size_t DEFAULT_NUM_PREDATORS = 1;
...
const Real ALIGNMENT_RANGE = 4*SEPARATION_RANGE;
const Real COHESION_RANGE = 4*ALIGNMENT_RANGE;
const Real PREDATOR_RANGE = COHESION_RANGE;

const Real SEPARATION_RELAXATION = 0.25;
